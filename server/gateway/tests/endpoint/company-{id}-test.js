...
describe('/company/{id}', function() {
  ...
  //
  //     /*eslint-enable*/
  //     api.put('/v1/company/{id PARAM GOES HERE}')
  ...
  //   });
  //
  //   it('should respond with 406 Content type not supported...', function(done) {
  //     /*eslint-disable*/
  //     var schema = {
  //       "type": "object",
  //       "required": [
  ...
  //   });
  //
  //   it('should respond with 413 Message content too big...', function(done) {
  //     /*eslint-disable*/
  //     var schema = {
  //       "type": "object",
  //       "required": [
  ...
  //
  //     /*eslint-enable*/
  //     api.del('/v1/company/{id PARAM GOES HERE}')
  //     .set('Content-Type', 'application/json')
  //     .set({
  //       'context': 'DATA GOES HERE',
  //       'context-id': 'DATA GOES HERE'
  ...
  //   it('should respond with 200 A single company', function(done) {
  //     /*eslint-disable*/
  //     var schema = {
  //       "type": "object",
  //       "properties": {
  ...
  //
  //     /*eslint-enable*/
  //     api.get('/v1/company/{id PARAM GOES HERE}')
  //     .set('Content-Type', 'application/json')
  //     .set({
  //       'context': 'DATA GOES HERE',
  //       'context-id': 'DATA GOES HERE'
